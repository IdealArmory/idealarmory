 ...
 *
 * Required KV binding in Cloudflare Pages dashboard (Settings > Functions):
 *   CLICK_DATA — KV namespace ID: ac6a13b49e634aab8d942b2c3be5b472
 */
...
export async function onRequestGet(context) {
  ...
  if (env.CLICK_DATA) {
    try {
      ...
      // Lightweight per-retailer counter
